...
get_usage_and_exit(){
    echo "usage: "
    echo "PostFreeSurferPipelineBatch-long.sh --Subject <experiment list space separated> [options]"
    echo "options:"
...
Subjlist="HCA6002236_V2_MR.long.HCA6002236_V1_V2"
#EnvironmentScript="${HOME}/projects/Pipelines/Examples/Scripts/SetUpHCPPipeline.sh" #Pipeline environment script
EnvironmentScript=/data/hcp/scripts/SetUpHCPPipeline-long.sh
